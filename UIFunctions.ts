...
function drawFromUI() {
    ...
    let shapeBuilder: [number, number, boolean, DrawType];
    let shapeChosen: number = checkShape();
    let styleChosen: [boolean,DrawType] = checkStyle();
    let sizeArr: number[] = setSize();
    ...
    function checkStyle(): [boolean,DrawType] {
